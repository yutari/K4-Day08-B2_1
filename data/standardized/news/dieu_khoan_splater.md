# CHÍNH SÁCH QUY ĐỊNH: DIEU KHOAN SPLATER

---

---
doc_id: xin-cho-shopee-c-th-gip-g-cho-bn-118121
title: "Xin chào, Shopee có thể giúp gì cho bạn?"
source_url: https://help.shopee.vn/portal/article/118121
retrieved_at: 2026-08-03
document_version: "not-stated"
customer_role: both
category: iu-khon-v-iu-kin-dch-v-spaylater-dnh-cho
language: vi
---
...
b)    Quá trình sử dụng Khoản tín dụng và hoàn trả dư nợ của khoản vay để báo cáo theo quy định cho Trung tâm thông tin tín dụng Quốc gia Việt Nam (CIC) và công ty Cổ phần Thông tin tín dụng Việt Nam (PCB) để đánh giá tín dụng
...
c)    thực hiện bất kỳ hành động pháp lý nào đối với bạn để được hoàn trả bất kỳ và tất cả các chi phí trên cơ sở bồi thường (bao gồm, nhưng không giới hạn ở các chi phí pháp lý và hành chính hợp lý) do bất kỳ hành vi vi phạm nào của bạn; và / hoặc
...
Các Điều khoản và Điều kiện của Dịch vụ này và việc thực hiện các điều khoản này sẽ được áp dụng bởi luật pháp của Cộng hòa Xã hội Chủ nghĩa Việt Nam.
...
*Lưu ý: Kể từ ngày 01/11/2025, Dịch vụ SPayLater được cung cấp và điều chỉnh theo Điều khoản và điều kiện Dịch vụ SPayLater mới có thể được truy cập tại ĐÂY .
